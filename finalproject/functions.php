...
function finalTheme_theme_setup()
{
...
add_action('after_setup_theme', 'finalTheme_theme_setup');
...
add_action('init', 'hardware_init');
//shortcode
function hardware_shortcode()
{
    $query = new WP_Query(array('post_type' => 'hardware', 'post_per_page' => 3, 'order' => 'asc'));
...
add_shortcode('hardware', 'game_shortcode');
